...
void init_endpoints_usb3(void)
{
	...
	endp7_rx.max_packet_size_with_burst =
		USB3_ENDP_1_15_MAX_PACKET_SIZE * DEF_ENDP_OUT_BURST_LEVEL;
...
{
	endp1_rx.buffer = endp1_rx_buffer;
	endp1_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp1_rx.max_burst = 1;
	endp1_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp1_tx.buffer = NULL;
	endp1_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp1_tx.max_burst = 1;
	endp1_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp2_rx.buffer = endp2_rx_buffer;
	endp2_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp2_rx.max_burst = 1;
	endp2_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp2_tx.buffer = NULL;
	endp2_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp2_tx.max_burst = 1;
	endp2_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp3_rx.buffer = endp3_rx_buffer;
	endp3_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp3_rx.max_burst = 1;
	endp3_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp3_tx.buffer = NULL;
	endp3_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp3_tx.max_burst = 1;
	endp3_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp4_rx.buffer = endp4_rx_buffer;
	endp4_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp4_rx.max_burst = 1;
	endp4_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp4_tx.buffer = NULL;
	endp4_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp4_tx.max_burst = 1;
	endp4_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp5_rx.buffer = endp5_rx_buffer;
	endp5_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp5_rx.max_burst = 1;
	endp5_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp5_tx.buffer = NULL;
	endp5_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp5_tx.max_burst = 1;
	endp5_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp6_rx.buffer = endp6_rx_buffer;
	endp6_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp6_rx.max_burst = 1;
	endp6_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp6_tx.buffer = NULL;
	endp6_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp6_tx.max_burst = 1;
	endp6_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp7_rx.buffer = endp7_rx_buffer;
	endp7_rx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp7_rx.max_burst = 1;
	endp7_rx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;

	endp7_tx.buffer = NULL;
	endp7_tx.max_packet_size = USB2_ENDP_1_15_MAX_PACKET_SIZE;
	endp7_tx.max_burst = 1;
	endp7_tx.max_packet_size_with_burst = USB2_ENDP_1_15_MAX_PACKET_SIZE;
}
#endif
