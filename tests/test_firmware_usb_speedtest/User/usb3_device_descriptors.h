...
void init_usb3_descriptors(void)
{
	...
	usb3_descriptors.other_descr.usb_endp_descr_5 = (USB_ENDP_DESCR){
		.bLength = 0x07,
		.bDescriptorType = 0x05,
		.bEndpointAddress = (ENDPOINT_DESCRIPTOR_ADDRESS_OUT | 0x05) &
							ENDPOINT_DESCRIPTOR_ADDRESS_MASK,
		.bmAttributes = ENDPOINT_DESCRIPTOR_BULK_TRANSFER,
		.wMaxPacketSizeL = 0x00,
		.wMaxPacketSizeH = 0x04, // 1024 bytes
	...
	usb3_descriptors.other_descr.usb_endp_companion_descr_5 =
		(USB_ENDP_COMPANION_DESCR){
			.bLength = 0x06,
			.bDescriptorType = 0x30,
			.bMaxBurst = DEF_ENDP_IN_BURST_LEVEL - 1,
	...
	usb3_descriptors.other_descr.usb_endp_descr_6 = (USB_ENDP_DESCR){
		.bLength = 0x07,
		.bDescriptorType = 0x05,
		.bEndpointAddress = (ENDPOINT_DESCRIPTOR_ADDRESS_OUT | 0x06) &
							ENDPOINT_DESCRIPTOR_ADDRESS_MASK,
		.bmAttributes = ENDPOINT_DESCRIPTOR_BULK_TRANSFER,
		.wMaxPacketSizeL = 0x00,
		.wMaxPacketSizeH = 0x04, // 1024 bytes
	...
	usb3_descriptors.other_descr.usb_endp_companion_descr_6 =
		(USB_ENDP_COMPANION_DESCR){
			.bLength = 0x06,
			.bDescriptorType = 0x30,
			.bMaxBurst = DEF_ENDP_IN_BURST_LEVEL - 1,
	...
	usb3_descriptors.other_descr.usb_endp_descr_7 = (USB_ENDP_DESCR){
		.bLength = 0x07,
		.bDescriptorType = 0x05,
		.bEndpointAddress = (ENDPOINT_DESCRIPTOR_ADDRESS_OUT | 0x07) &
							ENDPOINT_DESCRIPTOR_ADDRESS_MASK,
		.bmAttributes = ENDPOINT_DESCRIPTOR_BULK_TRANSFER,
		.wMaxPacketSizeL = 0x00,
		.wMaxPacketSizeH = 0x04, // 1024 bytes
	...
	usb3_descriptors.other_descr.usb_endp_companion_descr_7 =
		(USB_ENDP_COMPANION_DESCR){
			.bLength = 0x06,
			.bDescriptorType = 0x30,
			.bMaxBurst = DEF_ENDP_IN_BURST_LEVEL - 1,
	...
	usb3_descriptors.other_descr.usb_endp_descr_5_tx = (USB_ENDP_DESCR){
		.bLength = 0x07,
		.bDescriptorType = 0x05,
		.bEndpointAddress = (ENDPOINT_DESCRIPTOR_ADDRESS_IN | 0x05) &
							ENDPOINT_DESCRIPTOR_ADDRESS_MASK,
		.bmAttributes = ENDPOINT_DESCRIPTOR_BULK_TRANSFER,
		.wMaxPacketSizeL = 0x00,
		.wMaxPacketSizeH = 0x04, // 1024 bytes
	...
	usb3_descriptors.other_descr.usb_endp_companion_descr_5_tx =
		(USB_ENDP_COMPANION_DESCR){
			.bLength = 0x06,
			.bDescriptorType = 0x30,
			.bMaxBurst = DEF_ENDP_IN_BURST_LEVEL - 1,
	...
	usb3_descriptors.other_descr.usb_endp_descr_6_tx = (USB_ENDP_DESCR){
		.bLength = 0x07,
		.bDescriptorType = 0x05,
		.bEndpointAddress = (ENDPOINT_DESCRIPTOR_ADDRESS_IN | 0x06) &
							ENDPOINT_DESCRIPTOR_ADDRESS_MASK,
		.bmAttributes = ENDPOINT_DESCRIPTOR_BULK_TRANSFER,
		.wMaxPacketSizeL = 0x00,
		.wMaxPacketSizeH = 0x04, // 1024 bytes
	...
	usb3_descriptors.other_descr.usb_endp_companion_descr_6_tx =
		(USB_ENDP_COMPANION_DESCR){
			.bLength = 0x06,
			.bDescriptorType = 0x30,
			.bMaxBurst = DEF_ENDP_IN_BURST_LEVEL - 1,
	...
	usb3_descriptors.other_descr.usb_endp_descr_7_tx = (USB_ENDP_DESCR){
		.bLength = 0x07,
		.bDescriptorType = 0x05,
		.bEndpointAddress = (ENDPOINT_DESCRIPTOR_ADDRESS_IN | 0x07) &
							ENDPOINT_DESCRIPTOR_ADDRESS_MASK,
		.bmAttributes = ENDPOINT_DESCRIPTOR_BULK_TRANSFER,
		.wMaxPacketSizeL = 0x00,
		.wMaxPacketSizeH = 0x04, // 1024 bytes
	...
	usb3_descriptors.other_descr.usb_endp_companion_descr_7_tx =
		(USB_ENDP_COMPANION_DESCR){
			.bLength = 0x06,
			.bDescriptorType = 0x30,
			.bMaxBurst = DEF_ENDP_IN_BURST_LEVEL - 1,
