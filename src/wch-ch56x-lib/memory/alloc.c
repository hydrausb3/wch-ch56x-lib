...
#include "wch-ch56x-lib/memory/alloc.h"
 ...
 */
/*
 * Marks the pool blocks as free (0). The number of allocated blocks is stored
 * in the block status.
 */
...
uint8_t pool_stats_used() { return ram_pool.blocks_used; }

uint8_t* pool_stats_blocks() { return ram_pool.blocks; }
